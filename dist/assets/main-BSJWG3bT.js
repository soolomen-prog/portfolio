...
Präsentationskatalog sowie weitere Werbemittel erstellt.
  ...
  `,t}function C(e){const t=document.createElement("section");return t.className="case-admin-row full",t.innerHTML=`
    <iframe
      ...
      allowfullscreen
    ></iframe>
  `,t}function I(e){const t=document.createElement("section");return t.className="case-admin-row",t.innerHTML=`
    <div>
      <img src="${e.left}" alt="">
    </div>
    <div>
