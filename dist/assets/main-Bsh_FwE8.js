...
Illustrationen sowie der visuellen Darstellung der Produkt-Renderings im Katalog.`},{type:"video-full",vimeoId:"794384040"},{type:"image-full",src:"/img/vakio/03.jpg"},{type:"text-right",text:`Das finale Design verbindet technische Präzision mit einer klaren visuellen Sprache,
die Vertrauen schafft und die Produkte als hochwertige Lösungen im Bereich Klimatechnik positioniert.`},{type:"image-full",src:"/img/vakio/04.jpg"},{type:"image-full",src:"/img/vakio/05.jpg"},{type:"image-full",src:"/img/vakio/06.jpg"},{type:"text-right",text:`Das Projekt resultierte in einer modernen, skalierbaren Website-Struktur,
die sowohl den Anforderungen von Geschäftskunden als auch von Privatkunden gerecht wird.`},{type:"image-full",src:"/img/vakio/07.jpg"}]},p={vakio:v};function k(e){const t=p[e];if(!t){console.warn(`Case "${e}" not found`);return}y(t),b(t),w(t),x(t.blocks)}function y(e){const t=document.querySelector(".case-title-text");t&&(t.textContent=e.header.title)}function b(e){const t=document.querySelector(".case-intro-title"),n=document.querySelector(".case-intro-features"),i=document.querySelector(".case-intro-year");t&&(t.textContent=e.header.subtitle),n&&(n.textContent=e.header.info),i&&(i.textContent=e.header.year);const a=document.querySelector(".case-intro-cover"),r=document.querySelector(".case-intro-image");a&&(a.innerHTML=`<img src="${e.intro.cover}" alt="" />`),r&&(r.innerHTML=`<img src="${e.intro.image}" alt="" />`)}function w(e){const t=document.querySelector(".case-task-heading"),n=document.querySelector(".case-task-text");t&&(t.textContent=e.task.title),n&&(n.textContent=e.task.text)}function x(e){const t=document.querySelector(".case-admin");t&&(t.innerHTML="",e.forEach(n=>{let i=null;switch(n.type){case"text-right":i=j(n);break;case"image-full":i=S(n);break;case"video-full":i=L(n);break;default:console.warn("Unknown block type:",n.type)}i&&t.appendChild(i)}))}function j(e){const t=document.createElement("section");return t.className="case-intro-row",t.innerHTML=`
