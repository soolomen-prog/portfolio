const c=[{id:"vakio",category:"web",title:"VAKIO",subtitle:"Online-Shop für Klimasysteme",features:["UI — UX Design","Über 20 Seiten"],year:2022,coverImage:"/img/vakio/cover.jpg",homeDescription:"Website für Klimatechnik mit integriertem Online-Shop.",side:"left",visibleOnHome:!0,order:1},{id:"dolcevita",category:"web",title:"Dolcevita",subtitle:"Website für Kosmetologie",features:["UI-Design","Über 18 Seiten"],year:2022,coverImage:"/img/dolcevita/cover.jpg",homeDescription:"Unternehmenswebsite für eine Kosmetikklinik.",side:"left",visibleOnHome:!0,order:2},{id:"has",category:"branding",title:"HAS",subtitle:"Türkisches Trinkwasser",features:["Brand Identity","Landing page","Packaging","Catalog"],year:2022,coverImage:"/img/has/cover.jpg",homeDescription:"Brand Identity und Verpackungsdesign für Trinkwasser.",side:"right",visibleOnHome:!0,order:1}],y={id:"vakio",category:"webdesign",header:{title:"VAKIO",subtitle:"Online-Shop für Klimasysteme",info:"UI — UX Design / Über 20 Seiten",year:"2022"},intro:{cover:"/img/vakio/cover.jpg",image:"/img/vakio/intro.jpg"},task:{title:"Projectaufgabe",text:`Den Corporate-Website eines Unternehmens für Klimatechnik aktualisieren.
...
Präsentationskatalog sowie weitere Werbemittel erstellt.`},{type:"images-two",left:"/img/has/06.jpg",right:"/img/has/07.jpg"},{type:"image-full",src:"/img/has/08.jpg"},{type:"image-full",src:"/img/has/09.jpg"},{type:"image-full",src:"/img/has/10.jpg"},{type:"image-full",src:"/img/has/11.jpg"}]},j={vakio:y,dolcevita:b,has:w};function z(e){const t=j[e];if(!t){console.warn(`Case "${e}" not found`);return}x(t),S(t),E(t),L(t.blocks)}function x(e){const t=document.querySelector(".case-title-text");t&&(t.textContent=e.header.title)}function S(e){const t=document.querySelector(".case-intro-title"),n=document.querySelector(".case-intro-features"),i=document.querySelector(".case-intro-year");t&&(t.textContent=e.header.subtitle),n&&(n.textContent=e.header.info),i&&(i.textContent=e.header.year);const s=document.querySelector(".case-intro-cover"),r=document.querySelector(".case-intro-image");s&&(s.innerHTML=`<img src="${e.intro.cover}" alt="">`),r&&(r.innerHTML=`<img src="${e.intro.image}" alt="">`)}function E(e){const t=document.querySelector(".case-task-heading"),n=document.querySelector(".case-task-text");t&&(t.textContent=e.task.title),n&&(n.textContent=e.task.text)}function L(e){const t=document.querySelector(".case-admin");t&&(t.innerHTML="",e.forEach(n=>{let i=null;switch(n.type){case"text-right":i=P(n);break;case"images-two":i=I(n);break;case"image-full":i=D(n);break;case"video-full":i=C(n);break;default:console.warn("Unknown block type:",n.type)}i&&t.appendChild(i)}))}function P(e){const t=document.createElement("section");t.className="case-admin-row";const n=e.text.split(/\n\s*\n/).map(i=>i.replace(/\n/g," ").trim()).filter(Boolean).map(i=>`<p>${i}</p>`).join("");return t.innerHTML=`
  ...
  `,t}function C(e){const t=document.createElement("section");return t.className="case-admin-row full",t.innerHTML=`
    <iframe
      ...
      allowfullscreen
    ></iframe>
  `,t}function I(e){const t=document.createElement("section");return t.className="case-admin-row images-two",t.innerHTML=`
    <div class="images-two-inner">
      <div class="images-two-col">
        <img src="${e.left}" alt="" loading="lazy" />
      </div>
      <div class="images-two-col">
        <img src="${e.right}" alt="" loading="lazy" />
      </div>
    </div>
