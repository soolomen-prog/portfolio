export default {
  ...
  header: {
    ...
    info: 'Brand Identity / Landing page / Packaging / Catalog',
    year: '2022',
  },

  intro: {
    cover: '/img/has/cover.jpg',
    image: '/img/has/intro.jpg',
  },

  task: {
    title: 'Projectaufgabe',
    text: `Entwicklung einer Markenidentität für hydrogenreiches Trinkwasser.
...
Umsetzung einer vollständigen Markenverpackung`,
  ...
  blocks: [
    ...
    {
      type: 'text-right',
      text: `Der Name HAS wurde vom Kunden vorgegeben und bildete eine ideale Grundlage
...
der Zukunft.`,
    ...
    {
      type: 'text-right',
      text: `Unter Berücksichtigung des Charakters der Marke wurde eine einzigartige
