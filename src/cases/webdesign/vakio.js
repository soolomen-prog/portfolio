export default {
  ...
  intro: {
    cover: '/img/vakio/cover.jpg',
    image: '/img/vakio/intro.jpg',
  },
...
also die Funktionalität eines Online-Shops zu integrieren.`,
  ...
  blocks: [
    ...
    {
      type: 'text-right',
      text: `Es wurde eine vollständig neue Sitemap entwickelt, mit dem Fokus darauf,
...
die Vertrauen schafft und die Produkte als hochwertige Lösungen im Bereich Klimatechnik positioniert.`,
    ...
    {
      type: 'image-full',
      src: '/img/vakio/05.jpg',
    },

    // 11 — IMAGE FULL
    {
      type: 'image-full',
      src: '/img/vakio/06.jpg',
    },

    // 12 — IMAGE FULL
    {
      type: 'image-full',
      src: '/img/vakio/07.jpg',
    },
